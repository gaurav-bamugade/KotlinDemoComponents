...
import com.example.kotlinbase.databinding.ActivityCameraX2Binding
...
class Camera_X2_Activity : AppCompatActivity() {
    private lateinit var viewBinding: ActivityCameraX2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // setContentView(R.layout.activity_camera_x2)
        viewBinding = ActivityCameraX2Binding.inflate(layoutInflater)
